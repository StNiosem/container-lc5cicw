...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lc5cicw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lc5cicw.containers.anotherwebservice.com/
...
```
git clone git@github.com:StNiosem/container-lc5cicw.git
cd container-lc5cicw
```
...
```
docker attach container-lc5cicw
```
